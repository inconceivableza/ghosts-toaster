...
echo "3. Click 'Add custom integration' (unless one already exists; check in the Custom tab under Integrations)"
...
echo " 8. (Optional) change the icon to the ghosts-toaster icon, in icons/"
echo ""
