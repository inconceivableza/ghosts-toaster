...
generate_site_config() {
    ...
    SITE_ENV_FILE="$env_file" envsubst < "$TEMPLATE_FILE" > "$output_file" '$SITE_ENV_FILE $SITE_NAME $SITE_DOMAIN'
...
for SITE_DOMAIN in $SITES_LIST; do
    ...
    echo "include:"
    echo "  - path: sites/$SITE_DOMAIN/$SITE_DOMAIN.yml"
    echo "    env_file: sites/$SITE_DOMAIN/site.env"
done > include-sites.yml
